...
confirm_threshold = 0         # minimal kemunculan untuk dianggap valid
                ...
                for box in result.boxes:
                    ...
                    if text != "":
                        ...
                        if count >= confirm_threshold and most_common_text != last_text:
                            ...
                            # kirim_data_masuk(hasplat, "D:\\kuliah JTD\\Rakitriset\\Diva\\detected_plate.jpg")
                            hasil = kirim_data_keluar(most_common_text)
                            if hasil:
                                print("MATCH")
                                gerak_servo_keluar()
                            else:
